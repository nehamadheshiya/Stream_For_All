  ...
  return (
    <div className='w-[115%] py-10 md:w-[50%] sm:h-[65%] text-center md:h-[100%] md:ml-10 md:mt-24'>
      ...
      <div className='flex justify-center items-center h-1'>
        <button className='block md:hidden text-center fixed bottom-4 h-16 z-50 w-60 bg-orange-700 text-base rounded-full  font-semibold text-white'>Download Now</button>
      </div>
    </div>
  );
}
